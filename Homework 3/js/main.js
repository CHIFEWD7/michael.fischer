...
$("body").removeClass("box purplebox");
...
$(".div").find("box add-para").append("<p>I have been added</p>");
...
$("#box3").find("span").css("font-family", "serif");


// 8.	Add a unique class to your CSS and add it to the articles in #row1
$("#row1").find("article").css("background-color", "black")
...
$("#row2").find("article").css("color", "white");
...
$("#row4").find("div").css("border-color", "red");
...
$("#reset").on('click', function(){
	...
	$(".container").find("h2, .box, .footer").fadeIn();
	$(".container").remove("border-color", "red");
